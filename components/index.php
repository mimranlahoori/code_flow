<?php
function Card($heading, $description, $link)
{
    echo "
<div class='max-w-sm bg-gray-400 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700'>
    <a href='$link'>
        <img class='rounded-t-lg' src='' alt='This is an Image.' />
    </a>
    <div class='p-5'>
        <a href='$link'>
...
$users = array(
    array('name'=>'Imran','age'=>27 , 'city'=>'lahore'),
    array('name'=>'kamran','age'=>25 , 'city'=>'karachi'),
    array('name'=>'abdullah','age'=>26 , 'city'=>'islamabad')
)
